      ...
      {showForm && (
        <form className="card form" onSubmit={create}>
          ...
          <div className="grid-2">
            <label>
              Biased prompt
              <textarea rows={5} value={form.biasedPrompt} onChange={set('biasedPrompt')} required />
            </label>
            <label>
              Neutral prompt
              <textarea rows={5} value={form.neutralPrompt} onChange={set('neutralPrompt')} required />
            </label>
          </div>
          <div className="grid-2">
            <label>
